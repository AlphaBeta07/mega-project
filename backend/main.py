...
from rag import (
    ...
    generate_podcast_script, generate_tts_audio, generate_infographic_markdown, generate_mind_map_data, generate_video_overview
)
...
async def create_infographic(request: InfographicRequest):
    """Generate a structured Markdown infographic from selected sources and save artifact in MongoDB."""
    try:
        ...
        await ArtifactCRUD.save_artifact(db, {
            ...
            "content_data": {"markdown": markdown_content, "style": request.style},
            "selected_source_ids": request.selected_source_ids or [],
            "response_language": request.response_language or "English"
        })
